...
> Note that we set `carry_hazard = TRUE`. This argument ensures that if a hazard
> estimate is 0, it is replaced by the last non-zero estimate.
...
The package can also derive the Cumulative Distribution Function (CDF) directly
